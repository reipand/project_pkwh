...
// Definisikan biaya pendaftaran di satu tempat
define('REGISTRATION_FEE', 500000);
define('REGISTRATION_FEE_FORMATTED', 'Rp ' . number_format(REGISTRATION_FEE, 0, ',', '.'));
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_FILES['payment_proof']) && $_FILES['payment_proof']['error'] === UPLOAD_ERR_OK) {
            ...
            // --- SECURITY FIX: Validate file extension AND content ---
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                $error_message = 'File yang diupload bukan gambar yang valid.';
                ...
                if (move_uploaded_file($file['tmp_name'], $upload_path)) {
                    // --- LOGIC FIX: Update status to pending verification ---
                    ...
                    if ($updateStmt->execute()) {
                        ...
                        header('Location: dashboard.php?message=payment_success');
