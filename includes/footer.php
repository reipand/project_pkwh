            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo $base_path; ?>index.php#pendaftaran" class="text-light text-decoration-none">Pendaftaran Siswa Baru</a></li>
                        <li><a href="<?php echo $base_path; ?>index.php#prosedur" class="text-light text-decoration-none">Tata Cara Pendaftaran</a></li>
                        <li><a href="<?php echo $base_path; ?>index.php#informasi" class="text-light text-decoration-none">Informasi Sekolah</a></li>
                        <li><a href="<?php echo $base_path; ?>index.php#gallery" class="text-light text-decoration-none">Galeri Kegiatan</a></li>
                        <li><a href="<?php echo $base_path; ?>login.php" class="text-light text-decoration-none">Login Siswa</a></li>
                    </ul>
                </div>
            </div>
