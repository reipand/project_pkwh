        ...
        <div class="hero-content fade-in">
            ...
            <div class="hero-buttons">
                <?php if (isset($_SESSION['user_id']) && $_SESSION['user_type'] === 'student'): ?>
                    <a href="dashboard.php" class="btn btn-primary-custom">Dashboard Saya</a>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="gallery-item animate-fade-in-up">
                    <img src="assets/image/ldkpd.png" alt="LOKPD 2025" class="img-fluid">
                    <div class="gallery-overlay">
                        <h5>LDKPD 2024</h5>
                        <p>Kegiatan Pendidikan Kepemimpinan Siswa 2024</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="gallery-item animate-fade-in-up">
                    <img src="assets/image/ldkpd.png" alt="ProgsiT 2024" class="img-fluid">
                    <div class="gallery-overlay">
                        <h5>ProgsiT 2024</h5>
            ...
            <div class="col-md-4 mb-4">
                <div class="gallery-item animate-fade-in-up">
                    <img src="assets/image/ldkpd.png" alt="Kegiatan Sekolah" class="img-fluid">
                    <div class="gallery-overlay">
            ...
            <div class="col-lg-8 mx-auto">
                <?php if (isset($_SESSION['user_id']) && $_SESSION['user_type'] === 'student'): ?>
                    <div class="text-center mb-5">
                        ...
                        <p class="lead">Anda sudah terdaftar sebagai siswa SMP Bina Informatika</p>
                        <div class="mt-4">
    ...
    <div class="container">
        ...
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="assets/image/ldkpd.png" alt="Kegiatan Sekolah">
                <div class="gallery-overlay">
            ...
            <div class="gallery-item">
                <img src="assets/image/ldkpd.png" alt="Kegiatan Belajar">
                <div class="gallery-overlay">
            ...
            <div class="gallery-item">
                <img src="assets/image/ldkpd.png" alt="Kegiatan Mengajar">
                <div class="gallery-overlay">
