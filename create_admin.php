...
<head>
    ...
    <style>
        :root {
            ...
            --lighter-green-bg: #c8e6c9;
        }

        body {
            background: linear-gradient(135deg, var(--light-green-bg) 0%, var(--lighter-green-bg) 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        /* Override and enhance Bootstrap styles */
        .btn-primary {
        ...
        /* Add focus style for better accessibility and branding */
